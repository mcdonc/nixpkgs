{ lib, stdenv, fetchFromGitHub, perl, gdb, cctools, xnu, bootstrap_cmds, autoreconfHook }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    rev = "1b6359bf61d38eeb1a4651527e654d40d15c4dc7";
    sha256 = "sha256-ry4ACaQE6y2qtixxSUsaI0on1bGRGlJWMKi9CPxWuFs=";
  };
